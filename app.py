...
st.set_page_config(
    page_title="Ovarian Cancer Detection & Assist",
    page_icon=":brain:",
    layout="wide",
)
...
categories = ["ovarian cancer", "no cancer"]

symptoms = {
    "Ovarian Cancer": ["Abdominal bloating", "Pelvic pain", "Difficulty eating", "Frequent urination", "Unexplained weight loss", "Fatigue", "Changes in menstrual cycle"],
    "No Tumor": ["No tumor-specific symptoms."],
}

# Load the trained model
def load_model():
    model_path = 'Ovary_Cancer_detection_model.keras'
...
st.title("Ovarian Cancer Detection & ChatBot")
